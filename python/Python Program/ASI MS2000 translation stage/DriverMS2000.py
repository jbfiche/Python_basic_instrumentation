...
The MS2000 class is used to control a translation stage using specific-codes. The 
...
class MS2000:
    ...
    def __init__(self):
        """
        For the class instantiation, the input variable port is indicating which 
    ...
    def OpenConnection(self):
        """
        The OpenConnection method opens the serial communication port and 
    ...
    def WaitForIdle(self):
        """
        The WaitForIdle method check every second whether the stage is moving or idle.
        A timeout is fixed 15s. 
